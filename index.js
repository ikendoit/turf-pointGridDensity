 ...
 * @param {string} [options.densities={}] if passed, the cells will have <width, height> as in densities.lngDen and densities.latDen
...
function pointGrid(bbox, cellSide, options) {
    ...
    if (densities) {
      cellWidth = densities.lngDen 
      cellHeight = densities.latDen
    }
    ...
    if (rotation){
      ...
      return transformRotate(featureCollection(results), rotationValue)
    } else {
